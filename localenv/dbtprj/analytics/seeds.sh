...
dbt seed --profiles-dir . --target dev --profile tla_seed --select TLA__CRYPTO_CANDLES_MINUTE
dbt test --profiles-dir . --target dev --profile tla_seed --select TLA__CRYPTO_CANDLES_MINUTE
